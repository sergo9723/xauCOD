...
//+------------------------------------------------------------------+
#property copyright   "vMoneixau v1.0 — новая стратегия, требует проверки в тестере"
#property version     "1.00"
#property strict
#property description "vMoneixau — H4 зоны + структура свингов + сессия/MA + M5 пробой зоны"
...
int OnInit()
{
   ...
   Print("════════════════════════════════════════════");
   Print("vMoneixau v1.0 запущен | magic LONG=", g_magicLong, " SHORT=", g_magicShort);
...
void DrawPanel()
{
   ...
   texts[n] = "═══ vMoneixau v1.0 ═══"; colors[n] = InpColorTitle; n++;
